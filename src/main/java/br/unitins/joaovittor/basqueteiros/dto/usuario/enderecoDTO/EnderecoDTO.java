package br.unitins.joaovittor.basqueteiros.dto.usuario.enderecoDTO;
...
public record EnderecoDTO(
        ...
        @NotBlank(message = "O número não pode ser nulo.") @Pattern(regexp = "^\\d+$", message = "O número deve ser numérico.") Integer numero) {
